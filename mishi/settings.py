...
SECRET_KEY = 'django-insecure-@fg*w66*vjqj4o!x0eg8+9#fgbe!0ttdzepy(*ckxn2fm-wt(j'
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Carpeta donde se recopilan los archivos estáticos en producción
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
